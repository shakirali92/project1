<?php 
require(APP_DIR.'/Resources/views/partials/head.php');?>
                  ...
                  <div class="table-responsive">
                    <table class="table border mb-0">
                      ...
                      <tbody>
                        ...
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><img class="avatar-img" src="<?= asset('assets/img/avatars/2.jpg')?>" alt="user@email.com"><span class="avatar-status bg-danger"></span></div>
                          </td>
                          <td>
                        ...
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><img class="avatar-img" src="<?= asset('assets/img/avatars/3.jpg')?>" alt="user@email.com"><span class="avatar-status bg-warning"></span></div>
                          </td>
                          <td>
                            <div>Quintin Ed</div>
                            <div class="small text-medium-emphasis"><span>New</span> | Registered: Jan 1, 2020</div>
                        ...
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><img class="avatar-img" src="<?= asset('assets/img/avatars/4.jpg')?>" alt="user@email.com"><span class="avatar-status bg-secondary"></span></div>
                          </td>
                          <td>
                        ...
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><img class="avatar-img" src="<?= asset('assets/img/avatars/6.jpg')?>" alt="user@email.com"><span class="avatar-status bg-danger"></span></div>
                          </td>
                          <td>
