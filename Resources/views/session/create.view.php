                        ...
                        <div class="card col-md-7 p-4 mb-0">
                            ...
                            ?>
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                        <button class="btn btn-primary px-4" type="submit" name="login" value="login">Login</button>
                                        </div>
                            ...
                            <form action="/register" method="POST">
                                <div class="card-body text-center">
                                    <div>
                                        ...
                                        <button class="btn btn-lg btn-outline-light mt-3" type="submit">Register Now!</button>
                                    </div>
                                </div>
                            </form>
                        </div>
