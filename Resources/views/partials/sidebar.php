<div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
    ...
    <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
        ...
        <li class="nav-item"><a class="nav-link" href="p1"><span class="nav-icon"></span> p1</a></li>
        <li class="nav-item"><a class="nav-link" href="p1"><span class="nav-icon"></span> p2</a></li>
        <li class="nav-item"><a class="nav-link" href="p1"><span class="nav-icon"></span> p3</a></li>
        <li class="nav-item"><a class="nav-link" href="p1"><span class="nav-icon"></span> p4</a></li>
        <li class="nav-item"><a class="nav-link" href="p1"><span class="nav-icon"></span> p5</a></li>
        <li class="nav-item"><a class="nav-link" href="p1"><span class="nav-icon"></span> p6</a></li>
        </ul>
    </li>
    <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
        <svg class="nav-icon">
